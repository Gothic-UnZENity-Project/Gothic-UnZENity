...
{
    /// <summary>
    /// Leverage this class to chec if an Async operation can continue or should wait until next frame.
    ...
    /// </summary>
    public class FrameSkipper : SingletonBehaviour<FrameSkipper>
    {

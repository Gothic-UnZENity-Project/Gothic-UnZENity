...
namespace GUZ.Core
{
	...
	public class Resource<T>
	{
		...
		/// already been loaded before, a cached version of the asset is returned, saving a call to <see cref="loader"/>,
		/// otherwise, the <see cref="loader"/> is called and its result cached and returned.
		/// </summary>
		/// <param name="key">The name of the asset to load by calling the <see cref="loader"/> function</param>
